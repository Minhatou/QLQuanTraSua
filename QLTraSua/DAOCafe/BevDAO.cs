...
namespace CoffeManager.DAOCafe
{
    public class BevDAO
    {
        ...
        public bool ThemTD(string tentd, int idtd, float gt, string linkanh)
        {
            string query = string.Format("insert ThucDon ( TenDoUong , IDLoaiDoUong , DonGia , Anh)VALUES  ( N'{0}', {1}, {2}, '{3}')", tentd, idtd, gt, linkanh);
        ...
        public bool CapNhatTD(string tentd, int idtd, float gt, string anh, int id)
        {
            string query = string.Format("update ThucDon set TenDoUong = N'{0}' , IDLoaiDoUong = {1} , DonGia = {2} , Anh = '{3}' WHERE ID = {4}", tentd, idtd, gt, anh, id);
